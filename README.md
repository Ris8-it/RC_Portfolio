...
Hello! This is my personal portfolio website. The site shows real work where fragile manual workflows and scanned paperwork were rebuilt into dependable Python and SQL pipelines, clean dashboards, and clear financial analysis.
...
The repository includes a GitHub Actions workflow, so publishing is a normal push using git.
...
If Pages is not configured yet:
