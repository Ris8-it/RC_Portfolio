...
```{=html}
<div class="ba-pair">
  <figure class="before"><span class="ba-tag">Before</span><img src="../images/doc-before-1.png" alt="Old pasted chart"><figcaption>Before · a chart pasted in by hand, frozen the moment it was copied</figcaption></figure>
...
```{=html}
<div class="ba-pair">
  <figure class="before"><span class="ba-tag">Before</span><img src="../images/doc-before-2.png" alt="Old Word doc"><figcaption>Before · another page from the old documentation, with its own formatting drift</figcaption></figure>
